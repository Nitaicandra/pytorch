...
def sequential_split(gm: torch.fx.GraphModule, node_call_back) -> torch.fx.GraphModule:
    ...
    based on the node_call_back. It doesn't mutate the input graph module. The node_call_back should return True if the node is a delimiter. 
    Delimiter will be the first node in the next submodule.
    """
